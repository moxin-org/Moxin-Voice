...
//!         moxin_widgets::live_design(cx);  // Register shared widgets
...
//! - [`app_trait`] - Plugin app interface (`MoxinApp`, `AppRegistry`)
...
///     fn live_register(cx: &mut Cx) {
///         moxin_widgets::live_design(cx);  // Register shared widgets first
