...
//!
//! ## Role in G2P Pipeline
//!
//! This is the **first stage** of English G2P (see `g2p_en` module):
//! 1. CMU Dictionary (this module) - Fast lookup for known words
//! 2. Neural Network (`g2p_en`) - Fallback for OOV words
//!
//! ## Why Use a Dictionary?
//!
//! CMU provides human-verified pronunciations that are more accurate than
//! neural network predictions for common words. The neural network learns
//! patterns but can make mistakes (e.g., "steak" → "steek" instead of "stake").
//!
//! ## Data Source
//!
